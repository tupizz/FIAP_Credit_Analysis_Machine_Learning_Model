...
dados = pd.read_csv(
    'https://raw.githubusercontent.com/tupizz/FIAP_Credit_Analysis_Machine_Learning_Model/main/df_clean.csv')

############################# Streamlit ############################
st.markdown('<style>div[role="listbox"] ul{background-color: #6e42ad}; </style>', unsafe_allow_html=True)

st.markdown("<h1 style='text-align: center; '> Formulário para Solicitação de Cartão de Crédito 🤑</h1>",
...
def main():
    ...
    cliente_pred = teste_novo_cliente.drop(['Is_Bad_payer'], axis=1)
